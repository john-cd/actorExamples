...
//  def props(hasher: HashComponent.HashService): Props = Props(new Worker(hasher))
//
//
...
//}
//
//class Worker(hashService: HashComponent.HashService) extends Actor with ActorLogging {
//
//  import Worker._
//
