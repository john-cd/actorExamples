...
//
//  // messages
//  final case class Hash(id: Long, filePath: String)
//
//  final case class Hashed(id: Long, filePath: String, hash: String)
//
//  final case class HashTimeout(id: Long)
//
//}
//
...
//        case Failure(x) => throw new HashException(x)
//        case Success(h) =>
//          timeout.cancel
